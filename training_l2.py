...
def main(argv = None):
    ...
    try:
    	...
    	cost = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(pred, y)) + l2_norm
            ...
            if (TRAIN == True):
                ...
                for epoch in range(training_epochs):
                    ...
                    for i in range(total_batch):
                        ...
                        [_, cost_val, loss_val] = sess.run([train_step, cost, l2_norm], feed_dict = {
                                x: batch_x,
                                y: batch_y,
                                keep_prob: dropout})
